 ...
 * del PID y así obtener el error más cercano a 0 posible. Una vez
 * que el error está dentro del threshold, se deja de tunear.
 * 
 * En lo posible, este programa se debe instalar con un PID inicial que
 * funcione, ya que caso contrario el robot se iría de la pista antes de
...
const double learnRate = 0.01;   // LEARN RATE
/////////////////////////////////////////////////////////////////////////
